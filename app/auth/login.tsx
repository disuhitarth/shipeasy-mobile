  ...
  return (
    ...
    >
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.sub}>Sign in to your ShipEasy account</Text>
        ...
        <TouchableOpacity style={styles.guestBtn} onPress={() => { enableGuest(); router.back(); }}>
...
const styles = StyleSheet.create({
  ...
  guestBtn: { height: 52, borderRadius: 14, alignItems: 'center', justifyContent: 'center', marginTop: 12 },
  guestText: { color: '#6B6B76', fontSize: 15, fontWeight: '600' },
